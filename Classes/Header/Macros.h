...
#define PLAYER_MIN_EAT_SPORE_SCORE 18     //达到这个分值，球球才可以吃孢子


//PLAYER_MACROS
#define PI 3.14f
#define PLAYER_MIN_DIVIDE_SCORE 38     //达到这个分值，球球才可以分裂
#define PLAYER_MIN_SPIT_SCORE 32     //达到这个分值，球球才能吐孢子

#define PLAYER_MAX_DIVISION_NUM 16     //玩家最大分身数量
#define EAT_PRICK_DIVISION_NUM 9     //碰到绿刺产生的分身数量

#define PLAYER_MIN_DIVIDE_DISTANCE 200     //玩家分身之间的最小距离
#define PLAYER_MIN_SPIT_DISTANCE 224     //玩家吐的孢子与分身之间的最小距离
